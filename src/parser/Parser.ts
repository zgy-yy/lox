...
// import { BlockStmt, BreakStmt, ClassStmt, ContinueStmt, ExpressionStmt, ForStmt, FunctionStmt, IfStmt, ReturnStmt, Stmt, VarStmt, WhileStmt } from "@/ast/Stmt";
...
//                     const stmt = this.classDeclaration();
//                     if (stmt) {
//                         statements.push(stmt);
//                     }
//                 } else {
